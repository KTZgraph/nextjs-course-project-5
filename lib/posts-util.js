...
export function getPostsFiles() { //fajne dla getStaticPaths
  return fs.readdirSync(postsDirectory);  //z tym że zwraca nazwy plików z ich rozszerzeniem
}
...
export function getAllPosts() { //nieasynchronicza bo synchornicze czytam pliki
  ...
  const postFiles = getPostsFiles(); // lista Array nazw plików
