...
export function getStaticProps(context) {//nieasynchronicza bo synchornicze czytam pliki
...
export function getStaticPaths(){//nieasynchronicza bo synchornicze czytam pliki
    return {
